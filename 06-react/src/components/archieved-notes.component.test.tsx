...
import { ArchievedNotesComponent, mapStateToProps, mapDispatchToProps } from './archieved-notes.component';
...
describe('ArchievedNotesComponent', () => {
    ...
    it('should not archieve note', () => {
        const res = component.find('NoteItemComponent').prop('onNoteArchieve')();
    ...
    it('should not show dearchieved notes', () => {
